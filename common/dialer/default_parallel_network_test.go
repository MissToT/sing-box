...
func (l *concurrentTestLogger) WarnContext(_ context.Context, args ...any) {
	l.access.Lock()
	defer l.access.Unlock()
...
func (l *concurrentTestLogger) WarnMessages() []string {
	l.access.Lock()
	defer l.access.Unlock()
	return append([]string(nil), l.warnMessages...)
}
